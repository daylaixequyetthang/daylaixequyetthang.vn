...
export const FEATURES = [
  { t: 'Học phí trọn gói', d: 'Một mức giá đến khi thi tốt nghiệp — gồm xăng, xe, sân bãi, DAT. Cam kết không phát sinh.' },
  ...
  { t: 'Văn phòng khắp Bình Thuận', d: 'Nhiều điểm ghi danh: Phan Thiết · La Gi · Bắc Bình… — đăng ký gần nhà hoặc online, bảo lưu khóa học tối đa 1 năm.' },
];

export const FAQS = [
  { q: 'Học phí trọn gói gồm những gì?', a: 'Đã bao gồm toàn bộ chi phí đào tạo: xăng, xe, giáo viên, sân bãi, lý thuyết, sa hình, chạy đường trường DAT và lệ phí thi tốt nghiệp. Có hợp đồng đầy đủ, cam kết không phát sinh.' },
  ...
  { q: 'Đăng ký ở đâu?', a: 'Bạn có thể đăng ký online (gọi/Zalo 084 875 1111, trung tâm tư vấn tận nơi) hoặc ghé văn phòng gần nhất. Một số văn phòng: 291 Trần Hưng Đạo (Phan Thiết); 280 Thống Nhất (La Gi); QL1A, Phan Hiệp (Bắc Bình).' },
...
export const REVIEWS = [
  { stars: 5, text: '3 tháng học tại đây thực sự thú vị. Thầy nhiệt tình, kèm sát từng buổi đường trường.', name: 'Học Viên', role: 'Hạng B', avatar: 'M' },
  { stars: 5, text: 'Học phí trọn gói rõ ràng, không phát sinh. Sân tập sát sân thi nên tự tin khi đi thi.', name: 'Học Viên', role: 'Hạng C1', avatar: 'H' },
  { stars: 5, text: 'Mình bận nên học lý thuyết online rất tiện. Nhân viên hỗ trợ hồ sơ tận tình.', name: 'Học Viên', role: 'Hạng B', avatar: 'T' },
];
